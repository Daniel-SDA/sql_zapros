...
(select Object_id from sys.tables where Name='рн_Продажи_Temp')
...
@stmt = N'IF OBJECT_ID(N''tempdb.dbo.##СборДанных_'', N''U'') IS NOT NULL
		  ...
		  select * from [ETL_1C_SQL].[dbo].[рн_Продажи] where convert(date,Период) ='2021-06-30'
...
SET @id_row = @id_row - 1
END;
select count(1) from [dbo].[рн_Продажи_TEMP]  where convert(date,Период) <'2021-06-30'
...
INSERT INTO [ETL_1C_SQL].[dbo].[рн_Продажи_TEMP_PREV] 
SELECT *  FROM [ETL_1C_SQL].[dbo].[рн_Продажи_TEMP] AS T1
WHERE not EXISTS (SELECT 1 FROM [ETL_1C_SQL].[dbo].[рн_Продажи_TEMP_PREV]  AS T2 
				  WHERE 
...
--truncate table [dbo].[рн_Продажи_TEMP]
ALTER INDEX ALL on [ETL_1C_SQL].[dbo].[рн_Продажи_TEMP]  disable
INSERT INTO [ETL_1C_SQL].[dbo].[рн_Продажи_TEMP] 
SELECT *  FROM [ETL_1C_SQL].[dbo].[рн_Продажи_TEMP_PREV] 

ALTER TABLE [dbo].[рн_Продажи_TEMP_PREV] SWITCH PARTITION 97 TO [dbo].[рн_Продажи_TEMP] PARTITION 97
